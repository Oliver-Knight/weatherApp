...
class SevenDaysCard extends StatelessWidget {
  WeatherModal modal;
  SevenDaysCard({Key? key, required this.modal}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    String rawTime = modal.time;
    String time = rawTime.split(' ')[1];
